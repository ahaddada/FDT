...
%(or a \{0,1,2\} IP) 
as a convex combination of feasible solutions, provided the IP integrality gap is bounded, when scaled by a factor depending on the integrality gap of the IP formulation.  This is the Fractional Decomposition Tree (FDT) algorithm.
