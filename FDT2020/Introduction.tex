...
\item We give proof-of-concept experimental results that demonstrate that FDT might be a reasonable heuristic in practice for some problems. For VC, FDT gives better solutions than the original feasibility pump \cite{fp1}, though requiring more time.  Similarly, for TAP, FDT usually gives much better solutions than the known 2-approximation \cite{FJ81}, but runs more slowly.
